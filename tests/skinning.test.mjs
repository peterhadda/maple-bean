...
import { poseMatrices, applyPose } from '../assets/character-kit/pose.js';
import { bakeSkinAttributes, writeBones, BONE_COUNT, injectSkinning } from '../assets/character-kit/skinning.js';
...
const POSES = [
  ...
  {sit:1,study:1,seatHeight:.54,time:2.7,male:true},
];
